...
We base our Theme: Master Cloud Access Security Broker Foo on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning Cloud Access Security Broker Foo](https://vanheemstrasystems.github.io/learning-cloud-access-security-broker-foo/)
